...
#ifndef EX2_MAC_ERROR_CONTROL_THIRD_PARTY_VITERBI_UTILS_H_
#define EX2_MAC_ERROR_CONTROL_THIRD_PARTY_VITERBI_UTILS_H_
...
#endif /* EX2_MAC_ERROR_CONTROL_THIRD_PARTY_VITERBI_UTILS_H_ */
